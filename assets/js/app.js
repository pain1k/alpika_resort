...
$(function () {
  ...
  if ($touchScroller.length) {
    $touchScroller.on('mousedown', function (e) {
      var $t = $(this);
      var startX = $t.scrollLeft() + e.pageX;
      var startY = $t.scrollTop() + e.pageY;
...
$(function () {
  ...
  if ($('.weather-block').length) {
    var $weatherBlocks = $('.weather-block');
    var $weatherInfo = $('.aside-weather .table');
    var weatherTitle = $('.weather-title');
    var height = $('.aside-weather .table.active').data('height');
    var title = $('.weather-block.active').children('.info-block-title')[0].innerHTML;
    weatherTitle.html("".concat(title, " <span>").concat(height, "\u043C</span>"));
    $weatherBlocks.on('click', function (e) {
      var num = $(this).data('num');
      var title = $(this).children('.info-block-title')[0].innerHTML;
      var height = $(this).data('height');
      weatherTitle.html("".concat(title, " <span>").concat(height, "\u043C</span>"));
      var $weatherTab = $("[data-num=".concat(num, "]"));
      $weatherBlocks.removeClass('active');
      $weatherInfo.removeClass('active');
      $weatherTab.addClass('active');
      $(this).addClass('active');
    });
    var swipeRight = $('.title-wrapper .next');
    var swipeLeft = $('.title-wrapper .prev');
    swipeRight.on('click', function () {
      var current = $('.aside-weather .table.active');
      var num = current.data('num');
      var next = $("[data-num=".concat(num + 1, "]"));

      if (num === 10) {
        next = $("[data-num=1]");
      }

      var title = next.children('.info-block-title')[0].innerHTML;
      var height = next.data('height');
      weatherTitle.html("".concat(title, " <span>").concat(height, "\u043C</span>"));
      $weatherBlocks.removeClass('active');
      $weatherInfo.removeClass('active');
    ...
    swipeLeft.on('click', function () {
      var current = $('.aside-weather .table.active');
      var num = current.data('num');
      var prev = $("[data-num=".concat(num - 1, "]"));

      if (num === 1) {
        prev = $("[data-num=10]");
      }

      var title = prev.children('.info-block-title')[0].innerHTML;
      var height = prev.data('height');
      weatherTitle.html("".concat(title, " <span>").concat(height, "\u043C</span>"));
      $weatherBlocks.removeClass('active');
      $weatherInfo.removeClass('active');
      prev.addClass('active');
    });
    var $tablinks = $('.switcher a');
    ...
    $tablinks.on('click', function (e) {
      ...
      $t.addClass('active');
      $("[data-tab=\"".concat($t.data('tab'), "\"]")).addClass('active');
      $tab.addClass('show');
    ...
    var $switchers = $('.search-link');
    var $legendInfo = $('.legend-info div');
    $legendInfo.addClass('show');
    $switchers.on('click', function (e) {
      e.preventDefault();
      var $t = $(this);
      var id = $t.data('tab');
      var $tab = $("[data-".concat(id, "=\"true\"]"));
    ...
    var $maps = $('.map picture');
    var $legendWeather = $('.legend-weather div');
    ...
    var $more = $('.more');
    var $closePopup = $('.close-popup-btn');
    var $popUpImage = $('.popup .wallpaper img');
    $('.info-block').on('click', function () {
      var $t = $(this).find('.more');
      var src = $t.data('src');
      $('.popup').removeClass('hidden');
      $popUpImage.attr('src', "".concat(src));
    });
...
/* harmony default export */ var simplebar_esm = ((/* unused pure expression or super */ null && (SimpleBar)));
//# sourceMappingURL=simplebar.esm.js.map

// EXTERNAL MODULE: ./src/assets/js/modules/fslightbox.js
var fslightbox = __webpack_require__(9593);
...
/* harmony default export */ var esm = ((/* unused pure expression or super */ null && (flatpickr)));

// EXTERNAL MODULE: ./node_modules/flatpickr/dist/l10n/ru.js
var ru = __webpack_require__(8809);
;// CONCATENATED MODULE: ./src/assets/js/modules/book.js


var Booking = function Booking() {
  var getNormalMonth = function getNormalMonth(month) {
    month = month + 1;
  ...
  var setReservationDates = function setReservationDates(selectedDates, dateStr, instance) {
    ...
    if (selectedDates.length === 2) {
      ...
      var date = startDateDay.getDate() + '.' + getNormalMonth(startDateDay.getMonth()) + (startDateDay.getFullYear() !== endDateDay.getFullYear() ? '.' + startDateDay.getFullYear() : '') + ' <span> - </span> ' + endDateDay.getDate() + '.' + getNormalMonth(endDateDay.getMonth()) + '.' + endDateDay.getFullYear();
      var title = startDateDay.getDate() + '.' + getNormalMonth(startDateDay.getMonth()) + (startDateDay.getFullYear() !== endDateDay.getFullYear() ? '.' + startDateDay.getFullYear() : '') + ' - ' + endDateDay.getDate() + '.' + getNormalMonth(endDateDay.getMonth()) + '.' + endDateDay.getFullYear();
  ...
  if ($('.booking__form-group').length > 0) {
    ...
    $('.booking__hotel-name').on('click', function () {
      var text = $(this).html();
      var span = $(this).parents('.booking__form-group').find('.span-value');
      span.html(text);
    ...
    $('.booking__person-button').each(function () {
      $(this).on('click', function () {
        ...
        var min = parseInt($(this).parents('.booking__person-quantity').find('input').data('min'));
        var val = $(this).parents('.booking__person-quantity').find('input').val();
...
var Sliders = function Sliders() {
  ...
  $('.infrastructure__slider').each(function () {
    var t = $(this);
    var infrastructure = new core(t[0], {
      modules: [Navigation, Pagination],
      speed: 1500,
      spaceBetween: 20,
      slidesPerView: 2.4,
  ...
  initSwiper();
  var galleryLinks = document.querySelectorAll('[data-url]');

  var fetchGallery = function fetchGallery(galleryLinks) {
    var _iterator = _createForOfIteratorHelper(galleryLinks),
        _step;
      ...
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        item.addEventListener('click', function (e) {
          ...
          fetchData(url).then(function (data) {
            ...
            document.querySelector('.home-gallery').innerHTML = section.querySelector('.home-gallery').innerHTML;
  ...
  $('.history__slider').each(function () {
    var t = $(this);
    var historySwiper = new core(t[0], {
      modules: [Navigation, Pagination],
      speed: 1500,
      spaceBetween: 20,
      slidesPerView: 1,
      ...
      on: {
        init: function init() {
          ...
          this.slides.forEach(function (slide, i) {
            var num = slide.dataset.year;
            var bullet = $(_this.pagination.bullets[i]);
            $(bullet.get(0)).html('<mark>' + num + '</mark>');
            var mark = $(bullet.get(0)).find('mark');
            mark.css({
              'left': mark.innerWidth() * -1 + 5 + 'rem',
              'bottom': mark.innerHeight() * -1 - 6 + 'rem'
            });
            $(window).on('resize', function () {
              mark.css({
                'left': mark.innerWidth() * -1 + 5 + 'rem',
  ...
  function addStyle() {
    $('.services__nav').each(function (i, _) {
      var el = $(this);
      var container = el.parents('.services__container');
      var title = container.find('.services__title');
      var image = container.find('.services__item-image');
      var titleHeight = title.innerHeight() + parseInt(title.css('marginBottom'));
      var imageHeight = image.innerHeight();
      var arrows = $('.services__arrows');

      if ($(window).width() < 992) {
        el.css('top', titleHeight + imageHeight + 14 + 'rem');
  ...
  addStyle();
  $(window).on('resize', function () {
    var title = $('.services__title');
    var image = $('.services__item-image');
    var titleHeight = title.innerHeight() + parseInt(title.css('marginBottom'));
    var imageHeight = image.innerHeight();
...
function sizeBullets(el) {
  if ($(window).width() <= 1200) {
    el.pagination.bullets.forEach(function (item) {
...
;// CONCATENATED MODULE: ./src/assets/js/modules/holidays.js
// import {toggleAttr} from './pure'
var toggleTrace = function toggleTrace() {
  var tg = $('.main-top__holidays-toggle');
  var dwup = $('.down-up');
  ...
  if (tg.length) {
    ...
    $(document).on('scroll', function () {
      ...
      var btn = $('.main-top--holidays').height() - header;
...
;// CONCATENATED MODULE: ./src/assets/js/modules/book-fixed.js
var BookFixed = function BookFixed() {
  var bookContainer = $('.main-top__booking');
  var banner = $('.main-top');
  var header = $('.header');
  var dropdownHotel = $('.reservation-hotel').next();
  var dropdownPersone = $('.reservation-person').next();
  ...
  if (bookContainer.length) {
    ...
    var bottonMd = $('.botton-md a');
    bottonMd.on('click', function (e) {
      e.preventDefault();
      var form = $('.botton-md').prev();
      var inputGroups = form.find('.input-groups');
      var lastGroup = inputGroups.find('.input-group:last');
      var formOptions = {
        'display': 'block',
        'height': '80vh',
        'gropOtions': {
    ...
    $(document).on('click', '.mobile-book-close', function () {
      ...
      for (var _i = 0, _arr = [form, inputGroups, lastGroup, bookContainer, body]; _i < _arr.length; _i++) {
        var item = _arr[_i];
...
;// CONCATENATED MODULE: ./src/assets/js/modules/mainMenu.js
var mainMenu = function mainMenu() {
  var toggler = $('.js-toggler');
  var menu = $('.main-menu');
  var closeBotton = $('[data-close]');
...
;// CONCATENATED MODULE: ./src/assets/js/modules/autoPosition.js
function autoPosition() {
  $('body').on('click', '.flatpickr-wrapper', function () {
    ...
    if (window.innerHeight + window.pageYOffset < elm.height() + elm.find('.flatpickr-calendar').height() + off.top) {
      elm.find('.flatpickr-calendar').css({
        'bottom': '101%',
        'top': 'auto'
      });
    } else {
  ...
  $('body').on('click', '.width-drop', function () {
    ...
    if (window.innerHeight + window.pageYOffset < elm.height() + elm.find('.booking__dropdown').height() + off.top) {
      elm.find('.booking__dropdown').css({
        'bottom': '101%',
        'top': 'auto'
      });
    } else {
...
var autoPositionOnScroll = function autoPositionOnScroll() {
  autoPosition();
  $(document).on('scroll', function () {
    autoPosition();
  });
};
;// CONCATENATED MODULE: ./src/assets/js/modules/signup.js
var Signup = function Signup() {
  var btn = $('.btn-signup');
  var signup = $('.program-signup');
  var closeBtn = $('.program-signup__close');
  btn.on('click', function (e) {
    e.preventDefault();
    var paddingOffset = window.innerWidth - document.body.offsetWidth;
...
;// CONCATENATED MODULE: ./src/assets/js/modules/news.js
var NewsFilter = function NewsFilter() {
  var select = $('.news__select');
...
;// CONCATENATED MODULE: ./src/assets/js/modules/sky.js
var SkyScroll = function SkyScroll() {
  var skySection = $('.sky-passes');
  var skp = $('#skp');
  ...
  if (skySection.length) {
    $(document).on('scroll', function () {
      ...
      document.querySelectorAll('.bx').forEach(function (el, i) {
        if (el.offsetTop - (parseInt($(el).css('paddingTop')) + parseInt($(el).prev().css('marginBottom'))) <= window.scrollY) {
          document.querySelectorAll('.sky-passes__nav-item').forEach(function (el) {
...
;// CONCATENATED MODULE: ./src/assets/js/modules/restourants.js
var Restourants = function Restourants() {
  var brone = $('.restaurants__brone');
  var topFooter = $('.main-top__footer').innerHeight();
  var banerHeight = $('.main-top').innerHeight();
...
;// CONCATENATED MODULE: ./src/assets/js/modules/roads.js
var Roads = function Roads() {
  var roadTop = $('.roads__top');
  var roadList = $('.roads__list');
  var title = $('.roads__title');
...
// EXTERNAL MODULE: ./src/assets/js/modules/scrollertouch.js
var scrollertouch = __webpack_require__(1387);
// EXTERNAL MODULE: ./src/assets/js/modules/tabs.js
var tabs = __webpack_require__(2341);
// EXTERNAL MODULE: ./src/assets/js/modules/map.js
var map = __webpack_require__(5558);
